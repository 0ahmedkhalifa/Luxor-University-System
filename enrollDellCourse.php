...
$id=$_GET['id']; 
             ...
             $result000= $database->query("select * from register where s_id='$id' ");
             for ( $x=0; $x<$result000->num_rows&&$result->num_rows ;$x++){
                                               
             $row80=$result000->fetch_assoc();
                   $s_id=$row80['s_id'];
                   $c_code=$row80['c_code'];
            
             $result= $database->query(" select * from courses where course_code='$c_code'");
                 ...
                 $credit_hours=$row00['credit_hours'];
             }     
           ?>
            
<center>
<h1 style="font-size:20px"> جميع المقررات </h1>
</center>
<br>
                <table class="table table-striped">
                    ...
                    <?php
                     ...
                     $result000= $database->query(" SELECT * FROM `courses`");
                     for ( $x=0; $x<$result000->num_rows ;$x++){
                                               
              
           
              
                 $row00=$result000->fetch_assoc();
           ...
           <tr>
           <td><input type="checkbox" name="check" value="'.$course_code.'"></td>
          ...
          ';
             ...
             ?> 
                ...
                <input type="submit"class="btn btn-secondary"name="add" value="اضافة المقرر">
             </div>
            </div>
        </div>
    </div>
