...
if($_POST){
    ...
    $result= $database->query("select * from members where email='$email' and name='$name'");
            ...
            $checker = $database->query("select * from members where name='$name' and email='$email'");
            if ($checker->num_rows==1){
                ...
                header('location: professorcourses.php?&name='.$name.'&email='.$email.'');
            ...
            <div class="seccond-container ">
                <div class="row justify-content-between">
                    ...
                    <h1>تسجيل الدخول</h1>
                        ...
                        <div class="mb-3">
                            <label for="user">اسم الدكتور</label>
                            <input type="text"  name="name" class="form-control mt-3" id="user" placeholder="ادخل الاسم ">
                        </div>
                        <div class="mb-3" >
                            <label for="user">البريد الإلكتروني</label>
                            <input type="email"  name="email" class="form-control mt-3" id="user" placeholder="ادخل البريد الإلكتروني">
                        </div>
                        <div class="mb-3">
